    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('listings', models.ManyToManyField(related_name='amenities', to='booking.listing')),
            ],
        ),
        migrations.CreateModel(
            name='ListingImage',
            fields=[
                ...
                ('listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='booking.listing')),
            ],
        ),
        migrations.CreateModel(
            name='Message',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reservations', to='booking.listing')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
